...
public class RandomApp {
    ...
    public static String generators[]={"ranmar","ranecu","ranlux","randomjava","null"};
    public static String distributions[]={"flat","gaussian"};
    public static String[] luxuryVals = { "0", "1", "2", "3", "4" };
    public static String[] randomGeneratorTypes = { "Ranmar","Ranecu","Ranlux","Randomjava","Null"};
    public static int RANMAR=0,RANECU=1,RANLUX=2,RANJAVA=3,NULL=4;
    public static int FLAT=0,GAUSSIAN=1;
