 ...
 * @version 1.0
 */
public class RolePerformanceFeedbackProtocol extends ProtocolAgent {
    public RolePerformanceFeedbackProtocol(Node node_) {
        super(Preferences.ROLE_PERF_FEEDBACK_PROTOCOL, node_);
