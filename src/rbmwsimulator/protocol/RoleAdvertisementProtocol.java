 ...
 * @version 1.0
 */
public class RoleAdvertisementProtocol extends ProtocolAgent {
    public RoleAdvertisementProtocol(Node node_) {
        super(Preferences.ROLE_ADVERTISEMENT_PROTOCOL, node_);
