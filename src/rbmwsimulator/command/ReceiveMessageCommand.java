 ...
 * @version 1.0
 */
public class ReceiveMessageCommand extends Command{
    ...
    public ReceiveMessageCommand(double receiveTime, int senderNodeId_, int receiverNodeId_, WirelessNeighborhoodModel wirelessModel_, Message msg) {
      super("Receive", receiveTime);
    ...
    public void execute() {
      this.wirelessModel.signalMessageReceptionFor(this.senderNodeId, this.receiverNodeId, this.message);
    }
}
